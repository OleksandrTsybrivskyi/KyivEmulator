...
//==========================================================================================================
        ...
        case logic_operations_t::opcode_log_or:{
            word_t v1 = kmem.read_memory(addr3_shifted.source_1);
            word_t v2 = kmem.read_memory(addr3_shifted.source_2);
            word_t r  = v1 | v2;
            kmem.write_memory(addr3_shifted.destination, r);
            std::cout << "OR: a1=" << v1 << " a2=" << v2 << " res=" << r
                    << " bin=" << std::bitset<41>(r) << std::endl;
            ++C_reg;
        }
            break;
